...
| Title | Description | Status | File |
|---|---|---|---|
| Starting the pipeline early: a response to the DOE Genesis Mission RFI | A citizen response to the Department of Energy's 2026 RFI on AI workforce development, arguing that the talent pipeline for dual competency AI and science programs needs to begin in middle school – and proposing a framework to make that happen. | Final | pages/article-DE-SC-26-016.mdx |
| Building my online home | The infrastructure behind my personal site and knowledge base - plus the design principles and decisions that shaped it. | Final | pages/article-infrastructure.mdx |
| On Knowledge Management |  | Unknown | pages/article-knowledge-management.mdx |
| A note on stepping back from LinkedIn | Why I stripped my LinkedIn profile down to a photo and redirect. | Final | pages/article-linkedin.mdx |
| The case for documenting and sharing what you know | Why knowledge should be shared – structured, evergreen, and free. | Final | pages/article-share-knowledge.mdx |
| Tech Stack |  | Unknown | pages/article-tech-stack.mdx |
...
| Title | Description | Status | File |
|---|---|---|---|
| Books & Papers | A personal library catalog and reading log – a detailed record of every book and paper you own, want to read, or have read. | Placeholder | pages/collection-books-and-papers.mdx |
...
| Projects | A flexible project tracker for anything that requires more than a single task to complete – from a few hours to multi-year undertakings. | Placeholder | pages/collection-projects.mdx |
| Routines | A database for managing repeating processes – from weekly reviews to seasonal checklists to annual rituals. | Placeholder | pages/collection-routines.mdx |
| Things | A personal shopping and wish list database — a running catalog of items you want to buy, are considering, or have already purchased. | Placeholder | pages/collection-things.mdx |
...
| Title | Description | Status | File |
|---|---|---|---|
| Updates | New and modified pages | Unknown | pages/change-log.mdx |
| License | Work licensed under CC BY-NC-SA 4.0 | Final | pages/license.mdx |
| (no title) |  | Unknown | pages/snippet-template.mdx |
| Pending | Pending | Draft | pages/temp.mdx |
